...
<div class="flex flex-wrap gap-4 px-4 py-3 shadow-sm lg:hidden">
            ...
            <div class="flex items-center gap-x-5 max-md:gap-x-4">
                ...
                <div class="relative">
                    <span
                        ...
                        @click="$refs.searchPopup.style.display = 'flex'"
                    ></span>

                    <!-- Search Popup -->
                    <div
                        ref="searchPopup"
                        class="fixed inset-0 z-50 hidden items-start justify-center bg-black bg-opacity-50 pt-20"
                        @click="$refs.searchPopup.style.display = 'none'"
                    >
                        <div
                            class="w-full max-w-2xl rounded-lg bg-white p-4 shadow-lg"
                            @click.stop
                        >
                            <div class="mb-4 flex items-center justify-between">
                                <h2 class="text-xl font-semibold">Search Products</h2>
                                <button
                                    @click="$refs.searchPopup.style.display = 'none'"
                            ...
                            >
                                <input
                                    type="text"
                                    name="query"
                                    class="w-full rounded-xl border border-gray-300 px-11 py-3.5 text-sm font-medium"
                                    placeholder="@lang('shop::app.components.layouts.header.search-text')"
                                    required
                                    autofocus
                                >

                                <div class="icon-search pointer-events-none absolute top-3.5 text-2xl text-gray-400 ltr:left-3 rtl:right-3"></div>
