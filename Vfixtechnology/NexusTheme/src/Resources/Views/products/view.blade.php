        ...
        >
            ...
            >
                ...
                >
                    ...
                    <div class="fixed bottom-0 left-0 right-0 z-[8] bg-white shadow-lg border-t border-gray-100 lg:hidden">
                        <div class="container mx-auto px-3 py-2.5">
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <button
                                        type="button"
                                        class="flex items-center justify-center rounded-md secondary-button px-4 py-1.5 font-medium"
                                        :disabled="isStoring.addToCart"
                                        @click="is_buy_now=0; $refs.formData.requestSubmit()"
                                    >
                                    ...
                                    <button
                                        type="button"
                                        class="flex items-center justify-center rounded-md primary-button text-white px-4 py-1.5 font-medium"
                                        :disabled="isStoring.buyNow"
                                        @click="is_buy_now=1; $refs.formData.requestSubmit()"
                                    >
                                        Buy Now
                                    </button>
                                   @endif
