...
<div class="flex min-h-[78px] w-full justify-between border border-b border-l-0 border-r-0 border-t-0 px-[60px] max-1180:px-8">
    ...
    <div class="flex items-center gap-x-10 max-[1180px]:gap-x-4">
        ...
        <div style="margin-right:-25px !important;"  class="group relative flex h-[77px] items-center border-b-4 border-transparent hover:border-b-4 hover:border-navyBlue px-2"><span><a  href="/" class="inline-block  uppercase">Home</a></span></div>
        ...
        <div style="margin-left:-20px !important;" class="group relative flex h-[77px] items-center border-b-4 border-transparent hover:border-b-4 hover:border-navyBlue"><span><a  href="/contact-us" class="inline-block  uppercase">Contact</a></span></div>
