    ...
    <div class="flex w-full items-center justify-between">
        ...
        <div>
            <div class="flex items-center gap-x-5 max-md:gap-x-4">
                ...
                {{-- my custom search --}}
                <div class="relative">
                    <span class="icon-search cursor-pointer text-2xl"
                        @click="$refs.searchPopup.style.display = 'flex'"></span>
                    ...
                    <div ref="searchPopup"
                        ...
                        <div class="w-full max-w-2xl rounded-lg bg-white p-4 shadow-lg" @click.stop>
                            <div class="mb-4 flex items-center justify-between">
                                <h2 class="text-xl font-semibold">Search Products</h2>
                                <button @click="$refs.searchPopup.style.display = 'none'"
                            ...
                            <form action="{{ route('shop.search.index') }}" class="flex w-full items-center">
                                ...
                                <div class="relative w-full">
                                    ...
                                    <input type="text"
                                        ...
                                        name="query" value="{{ request('query') }}" placeholder="@lang('shop::app.components.layouts.header.mobile.search-text')"
                                        required>
